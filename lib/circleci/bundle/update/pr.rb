...
Powered by [compare_linker](https://rubygems.org/gems/compare_linker)
        ...
        def self.github_host
          match = "git@github.com:Linuxbrew/homebrew-extra.git".match %r{^.*@(.+?)[/|:]}
          match[1] if match
          match = "https://github.com/company/repo".match %r{https://(.+?)/}
          match[1] if match
          irb(main):096:0> ("https://github.com/company/repo".match %r{https://(.+?)/})
# => #<MatchData "https://github.com/" 1:"github.com">
# 
# "git@github.com:Linuxbrew/homebrew-extra.git".match %r{^*@(.+?)(/|:)}
#  #<MatchData "@github.com:" 1:"github.com" 2:":">
# 
# "git@github.com:Linuxbrew/homebrew-extra.git".match %r{^.*@(.+?)[/|:]}
# => #<MatchData "git@github.com:" 1:"github.com">
# 
# "github.com:rails/rails.git".match %r{(.+?)[/|:].*git$}
# 
# https://teratail.com/questions/120846?modal=q-comp
          "github.com"
        end
